"""
API Routes — HTTP layer for audiobook generation.

NOTE: This layer only accepts requests and delegates to the pipeline.
...
async def generate_audiobook(
    ...
    NO processing happens here — delegates to pipeline via queue.
    """
